        ...
        <Container>
          <div className="max-w-[1200px] mx-auto">
            ...
            <SpeakerTimeline data={[
              { name: 'Danny McMillan', badge: 'Host + Session 1', time: '09:30 - 11:00', image: 'https://sellersessions.github.io/sellersessions-design-system/speakers/danny-mcmillan.jpg', bio: 'Founder of Seller Sessions, co-founder of Databrill, advisor to Data Dive. Opens the day with a 90-minute deep dive into using Claude and Claude Code for Amazon operations -- live, on laptops, building alongside every delegate.' },
              { name: 'Shubhash Sharma', badge: 'Session 2', time: '11:15 - 12:30', image: 'https://sellersessions.github.io/sellersessions-design-system/speakers/shubhash-sharma.jpg', bio: 'Systems architect and entrepreneur building Not A Square -- intelligent systems that reduce decision fatigue and increase strategic clarity. Delivers a session on systems thinking for Amazon sellers: operational workflows that scale without burnout.' },
              { name: 'Matt Kostan', badge: 'Session 3', time: '13:30 - 14:30', image: 'https://sellersessions.github.io/sellersessions-design-system/speakers/matt-kostan.jpg', bio: 'Founder of ProductPinion. Built a platform to answer the question every seller faces: why don\'t customers buy? Covers AI-powered consumer testing to validate product decisions and reduce launch risk.' },
              { name: 'Sim Mahon', badge: 'Sessions 4 & 5', time: '14:45 - 17:00', image: 'https://sellersessions.github.io/sellersessions-design-system/speakers/sim-mahon.jpg', bio: 'Eight-figure seller with six private label brands. Known for operational discipline and brand-building at scale. Shares the afternoon block covering advanced brand-building and scaling strategies.' },
              { name: 'Dorian Gorski', badge: 'Sessions 4 & 5', time: '14:45 - 17:00', image: 'https://sellersessions.github.io/sellersessions-design-system/speakers/dorian-gorski.jpg', bio: 'The #1 stop-the-scroll main image specialist. CEO of Keplo.com. Shares the afternoon block with Sim, focusing on visual strategy, image testing, and the intersection of creative and data.' },
            ]} />
          </div>
        </Container>
      </Section>
